...
function PaymentResponse(props) {
    ...
    console.log('fsddfs', props.query)
      ...
      <>
         ...
         {paid?
            <div className="payment-peoceed-successfully">
                ...
                <h4>{getTranslatedText('heading.congratulations')}</h4>
               ...
               <div className="payment-peoceed-box">
                  ...
                  <div className="peoceed-content">
                     ...
                     <Form.Check
                        type='checkbox'
                        id="Agreeto"
                        label='l/We Agree to include the registration fee of ONE RUPEE in my first property tax assessment'
...
PaymentResponse.getInitialProps = async ({ mobxStore, query, req }) => {
